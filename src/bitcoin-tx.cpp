...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GECH Core GECH-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  GECH-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GECH transaction") + "\n" +
              "  GECH-tx [options] -create [commands]   " + _("Create hex-encoded GECH transaction") + "\n" +
              "\n";
