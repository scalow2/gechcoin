// Copyright (c) 2011-2015 The GECH Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GECH Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GECH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GECH: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->SingleColorIcon(":/icons/about"), tr("&About GECH Core"), this);
    aboutAction->setStatusTip(tr("Show information about GECH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GECH Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GECH addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->SingleColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GECH addresses"));
    ...
    openAction->setStatusTip(tr("Open a GECH: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->SingleColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GECH Core help message to get a list with possible GECH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GECH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GECH network", "", count));
}
...
{
    QString strTitle = tr("GECH"); // default title
