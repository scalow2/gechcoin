...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("GECH Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  GECH-cli [options] <command> [params]  " + _("Send command to GECH Core") + "\n" +
                  "  GECH-cli [options] help                " + _("List commands") + "\n" +
                  "  GECH-cli [options] help <command>      " + _("Get help for a command") + "\n";
